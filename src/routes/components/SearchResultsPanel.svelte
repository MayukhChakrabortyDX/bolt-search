<script lang="ts">
    ...
    let {
        ...
        isFolderScanning: (folderPath: string) => boolean;
    ...
    const statusText = $derived.by(() => {
        ...
        return "Search Status Bar - Empty";
    });
</script>
        ...
        {#if searching || searched}
            ...
            <div class="px-3 pb-2 flex items-center justify-between gap-3">
                ...
                >
                    ...
                    />
                    <span
                        class="font-medium text-zinc-700 dark:text-zinc-100 tabular-nums"
                ...
                {#each driveScanRows as row, i}
                    ...
                    >
                        <div class="flex items-center gap-1 min-w-0">
                            ...
                            />
                            <span
                                class="text-zinc-600 dark:text-zinc-200 font-medium truncate"
                                >{row.label}</span
                            >
                        </div>
                        <span
                            class="text-zinc-500 dark:text-zinc-400 whitespace-nowrap"
                        >
                ...
                {#each treeRows as row (row.node.path)}
                    {#if row.node.isDir}
                        ...
                        >
                            ...
                            />
                            <span
                                class="text-xs text-zinc-700 dark:text-zinc-100 font-medium"
                                >{row.node.name}</span
                            >
